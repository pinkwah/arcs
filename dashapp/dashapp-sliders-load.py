...
stats = load_data('./assets/stats_scan.json.gz')
paths = load_data('./assets/paths_scan.json.gz')
data = load_data('./assets/mean_data_scan.json.gz')
labels={0:['O',html.Sub(2),' (ppm)'],
        1:['H',html.Sub(2),'O (ppm)'],
        2:['SO',html.Sub(2),' (ppm)'],
        3:['NO',html.Sub(2),' (ppm)'],
        4:['H',html.Sub(2),'S (ppm)'],
        5:['T (K)'],
        6:['P (bar)']}
sliders = make_sliders(data,labels)
graph=None
table=None
table2=None
